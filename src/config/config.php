<?php
/**
 * Casset: Convenient asset library for Laravel.
 *
 * @package    Casset
 * @version    v1.0
 * @author     Antony Male
 * @author     Youn�s ElBiache <younes.elbiache@gmail.com>
 * @license    MIT License
 * @copyright  2013 Antony Male, Youn�s ElBiache
 * @link       http://github.com/younes0/laravel-casset
 */
...
return array(
    ...
    'paths' => array(
        ...
        'core_bower' => array(
            'path' => 'assets/',
            'js_dir' => 'bower_components/',
            'img_dir' => 'bower_components/',
            'css_dir' => 'bower_components/'
        ),
        'core_module' =>  array(
            'path'      =>'assets/modules/',
            'js_dir'   => '',
        ...
        'cdn_js' => array(
            'path' => 'http://cdnjs.cloudflare.com/',
            'js_dir' => '',
            'css_dir' => ''
        ),
        'net_dna' => array(
            'path' => 'http://netdna.bootstrapcdn.com/',
            'js_dir' => ''
        ),
        'google_maps' => array(
            'path' => 'http://maps.google.com/maps/',
            'js_dir' => ''
        ),
        'angular_ui' => array(
            'path' => 'http://angular-ui.github.io/',
            'js_dir' => ''
        )
    ),

    /**
     * URL to your Laravel root. If null/falsy, this will default to Request::root() (or URL::to('/') ),
